<x-app-layout>
    ...
    <div class="container py-8">
        ...
        <div class=" bg-cover px-4 py-2 bg-red-600  flex float-right">
            <p><a href="{{ route('noticias') }}" class="btn btn-light text-sm italic font-bold text center">Volver a
                    Noticias</a> </p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 ">
            ...
            <div class="lg:col-span-2">
                <figure class="flex justify-center">
                    @if ($noticia->portada)
                        <a href=" {{ asset('img/noticias/portadas/' . $noticia->portada) }}" id="openImage"
                            class="ed-item base-100 web-30 relative">
                            <img class ="w-full h-80 object-cover object-center"
                                src="{{ asset('img/noticias/portadas/' . $noticia->portada) }}" alt="">
                        </a>
                    @else
                        <a href="https://cdn.pixabay.com/photo/2016/07/28/16/50/car-engine-1548434_960_720.jpg"
                            class="ed-item base-100 web-30">
                            <img class ="w-full h-80 object-cover object-center"
                ...
                <div class="text-base text-gray-500 mt-4 text-justify">
                    <p class="mb-2"><strong class="text-xl font-bold text-gray-800"> IMÁGENES:</strong>
                    </p>
                    ...
                    <figure class="flex justify-center">
                        @foreach ($noticia->images as $imagen)
                            <div class="ed-item base-100 web-30 relative">
                                <img class="w-full h-80 object-cover object-center"
                                    src="{{ asset('img/noticias/imagenes/' . $imagen->image_path) }}" alt=""
                                    onclick="openModal('{{ asset('img/noticias/imagenes/' . $imagen->image_path) }}')">
                            </div>
                        @endforeach
                    </figure>
