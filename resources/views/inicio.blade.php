<x-app-layout>
    <style>
        ...
        /* Estilos generales para la imagen del slider */
        .imagen-fija {
        ...
        /* Estilos para el slider en vista de escritorio */
        @media (min-width: 768px) { /* Vista web */
            .imagen-fija {
                height: 500px; /* Altura mayor para la vista web */
                margin-top: 30px;
            }
        ...
        /* Estilos para el slider en vista móvil */
        @media (max-width: 767px) { /* Vista móvil */
            .imagen-fija {
                height: 250px; /* Altura menor para la vista móvil */
                margin-top: 60px;
            }
    ...
    <div class="container py-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="w-full p-4">
                ...
                <h2 class="text-xl font-bold text-gray-800 text-justify">Código</h2>
                <p class="text-base text-gray-700 text-justify">{!! $escuela->codigo !!}</p>
            </div>
        </div>
    </div>
    ...
    <div class="container py-4">
        <h1 class="text-2xl font-extrabold text-gray-900 text-center">Como Llegar</h1>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
    ...
    <div class="container py-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div class="w-full p-4">
                ...
                <p class="text-base text-gray-700 mt-2 text-center">{!! $escuela->direccion !!}</p>
            </div>
            <div class="w-full p-4">
                <h2 class="text-2xl font-bold text-gray-800 text-center">Teléfono</h2>
                <p class="text-base text-gray-700 mt-2 text-center">{!! $escuela->telefono !!}</p>
            </div>
            <div class="w-full p-4">
                <h2 class="text-2xl font-bold text-gray-800 text-center">Email</h2>
                <p class="text-base text-gray-700 mt-2 text-center">{!! $escuela->email !!}</p>
            </div>
        </div>
    </div>
