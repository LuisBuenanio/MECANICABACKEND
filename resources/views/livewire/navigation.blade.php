<nav class="bg-red-600" x-data="{open: false }">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div class="hidden sm:block sm:ml-6">
                <div class="flex space-x-4">
                    ...
                    <a href="https://cimogsys.espoch.edu.ec/idi/public/grupos/FM" class="text-white hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Investigación</a>
                    ...
                    <a href="{{route('convenios')}}" class="text-white hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Convenios</a>
                    <a href="{{route('proyectos')}}" class="text-white hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Proyectos</a>
                    ...
                    {{-- <a href="{{route('galerias')}}" class="text-white hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Gestión de Calidad</a>
                --}}
                </div>
            </div>
        </div>
