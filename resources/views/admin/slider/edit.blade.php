...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            {!! Form::model($slider,['route' => ['admin.slider.update',$slider->id], 'autocomplete' => 'off', 'files' => true, 'method' => 'put'])!!}

                @include('admin.slider.partials.form')

                {!! Form:: submit('Actualizar Imagen Slider',['class' => 'btn btn-primary']) !!}
