...
@section('content_header')
    <h1>Crear Nuevo Investigador</h1>
@stop

@section('content')
    <div class="card">
        <div class="card-body">
            {!! Form::open(['route' => 'admin.investigador.store1', 'autocomplete' => 'off', 'files' => true])!!}

                @include('admin.investigador.partials.form')

                {!! Form:: submit('Crear Investigador',['class' => 'btn btn-primary']) !!}
